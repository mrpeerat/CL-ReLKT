...
f_name = f"models/{corpus}/finetuned_USE_{corpus}_{mode}_en-{arg_config.languages}_top{top_start}-{top_end}_{context_mode}_{margin_trip}margin_{arg_config.warup_steps}WarmStep_{arg_config.loss_mode}Loss_{learning_rate}LR_RegFalse_FCFalse_new_bm25_finetune_DEV_no_same_doc"
...
print(f"FC dimension:{arg_config.fc_dimension}")
print(f"name:{f_name}")
print()
# -
...
for lan in languages: 
    ...
    file_name = f'triplet_en-{lan}_top{top_start}-{top_end}_{context_mode}_new_no_same_doc.csv'
